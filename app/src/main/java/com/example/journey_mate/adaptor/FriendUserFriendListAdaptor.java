...
public class FriendUserFriendListAdaptor extends RecyclerView.Adapter<FriendUserFriendListAdaptor.FriendListHolder>{
    Context context;
    List<FriendRelationResponce> friendlist;
    String id;
    FriendRequestApi friendRequestApi = new FriendRequestApi();

    public FriendUserFriendListAdaptor(Context context, List<FriendRelationResponce> friendlist, String id) {
    ...
    public void onBindViewHolder(@NonNull final FriendListHolder holder, int position) {
        ...
        if (friend.getUser_id_1().get_id().equals(id)){
