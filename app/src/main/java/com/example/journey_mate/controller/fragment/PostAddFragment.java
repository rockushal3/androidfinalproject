...
public class PostAddFragment extends DialogFragment implements View.OnClickListener{
    Uri uri;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        choosenimage = view.findViewById(R.id.picofpost);
        chooseimage = view.findViewById(R.id.choosepostimage);
        uploadimage= view.findViewById(R.id.btn_Postimage);
    ...
    switch (view.getId()){
        ...
        case  R.id.btn_Postimage:
            postApi.CreatePostByUser(image,post_desc.getText().toString());
            Toast.makeText(getContext(), "Your Post Created", Toast.LENGTH_SHORT).show();
            reload();
